...
const Button: React.FC<ButtonProps> = ({
  ...
  const variants: Record<ButtonVariant, string> = {
    primary: 'bg-[#3ddde1] text-[#070e17] hover:bg-[#34c4c8] disabled:bg-gray-400',
    secondary: 'bg-gray-200 text-gray-800 hover:bg-gray-300 disabled:bg-gray-100',
    outline: 'border border-gray-300 text-white hover:bg-gray-800 disabled:border-gray-200 disabled:text-gray-400',
  };
