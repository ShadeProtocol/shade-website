...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative bg-[#f2f2f2] dark:bg-[#070e17] overflow-hidden min-h-screen w-screen pb-40">
      <div
      ...
      <div className="pl-16 mt-8">
        <div className="flex items-center justify-between mb-8 pl-4 pr-12">
          <div className="text-2xl font-bold text-[#21a0a4]">Shade</div>
          <div className="flex items-center space-x-8">
            <a href="#how-to-use" className="text-base text-[#070e17]">How to Use</a>
            <a href="#docs" className="text-base text-[#070e17]">Docs</a>
            <a href="#sdk" className="text-base text-[#070e17]">SDK</a>
            <Button 
        ...
        <div className="max-w-5xl mt-32 text-left">
          <h1
            className="font-bold text-[#070e17] dark:text-white text-left text-4xl md:text-7xl lg:text-[108px] leading-[0.95] tracking-[-0.09em] max-w-[1177px] mb-8 font-inter"
            style={{
          ...
          <p className="text-xl md:text-2xl text-[#070e17] dark:text-white mb-8">
